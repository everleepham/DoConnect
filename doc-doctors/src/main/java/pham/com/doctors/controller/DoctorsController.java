package pham.com.doctors.controller;

import pham.com.doctors.dto.DoctorsDTO;
import pham.com.doctors.service.DoctorsService;
...
public class DoctorsController {
    ...
    public ResponseEntity<List<DoctorsDTO>> searchDoctorsBySpecialize(@RequestParam @PathVariable String specialization) {
        logger.info("Request received in controller to search doctors by specialize {}", specialization);
        List<DoctorsDTO> listDoctors = doctorsService.searchDoctorBySpecialization(specialization);
        return new ResponseEntity<>(listDoctors, HttpStatus.OK);
    }
}
