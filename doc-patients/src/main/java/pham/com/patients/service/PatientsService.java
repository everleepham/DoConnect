package pham.com.patients.service;


import pham.com.patients.dto.PatientsDTO;
import pham.com.patients.exception.ResourceNotFoundException;
...
public class PatientsService {
    ...
    public PatientsDTO updatePatient(Long id, PatientsDTO dto) {
        ...
        existingPatients.setFirstName(dto.getFirstName());
        existingPatients.setLastName(dto.getLastName());
    ...
    private Patients toEntity(PatientsDTO patientsDTO) {
        ...
        entity.setFirstName(patientsDTO.getFirstName());
        entity.setLastName(patientsDTO.getLastName());
